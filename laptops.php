...
$stmt = $pdo->prepare('SELECT * FROM laptops ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM laptops')->rowCount();
?>

<?=template_header('laptops')?>
