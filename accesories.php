...
$stmt = $pdo->prepare('SELECT * FROM accesories ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM accesories')->rowCount();
?>

<?=template_header('accesories')?>
