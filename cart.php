...
<div class="cart content-wrapper">
    ...
    <form action="index.php?page=cart" method="post">
        ...
        <div class="buttons">
            ...
            <button onclick="gotowhatsapp()">Place Order</button>
        </div>
    </form>
</div>
...
$productQtys = array(); // Array to store product quantities

if (!empty($products)) {
    foreach ($products as $product) {
        $productNames[] = $product['name']; // Add product name to the array
        $productQtys[] = $products_in_cart[$product['id']]; // Add product quantity to the array
    }
}
?>
...
function gotowhatsapp() {
    var names = <?php echo json_encode($productNames); ?>;
    var qtys = <?php echo json_encode($productQtys); ?>;

    var message = "Product Details:\n";
    for (var i = 0; i < names.length; i++) {
        message += "Name: " + names[i] + "\n";
        message += "Quantity: " + qtys[i] + "\n";
        message += "\n";
    }

    var phoneNumber = "+94741002003";
