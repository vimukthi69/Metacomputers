...
$stmt = $pdo->prepare('SELECT * FROM desktop ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $pdo->query('SELECT * FROM desktop')->rowCount();
?>

<?=template_header('desktop')?>
...
<div class="products content-wrapper">
    ...
    <div class="buttons">
        ...
        <a href="index.php?page=laptops&p=<?=$current_page-1?>">Prev</a>
        <?php endif; ?>
        <?php if ($total_products > ($current_page * $num_products_on_each_page) - $num_products_on_each_page + count($products)): ?>
        <a href="index.php?page=laptops&p=<?=$current_page+1?>">Next</a>
        <?php endif; ?>
    </div>
</div>
